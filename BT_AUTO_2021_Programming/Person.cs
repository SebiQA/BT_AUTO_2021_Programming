...
namespace BT_AUTO_2021_Programming
{
    public class Person : Iperson
    {
        ...
        public Person(string firstName, string flastName, string address, string city, string country, char sex, string[] nationality, bool isHungry, DateTime dob)
        {
            this.firstName = firstName;
        ...
        {
            Console.WriteLine("First name of the person is {0} and last name is {1}", p.firstName, p.lastName);
        }
    }
}
